...
def enforce_english_codes(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("articles", "0008_articlecategory_english_codes"),
    ]

    operations = [
        migrations.RunPython(enforce_english_codes, migrations.RunPython.noop),
    ]
